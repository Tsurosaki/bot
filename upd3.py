    ...
    try:
        ...
        if guide_path and guide_path.exists():
            ...
            guide_text = (
                ...
                "1. Нажмите кнопку '📂 Выбрать папку для загрузки'\n"
                "2. Выберите существующую папку или создайте новую (кнопка '➕ Создать папку')\n"
                "3. Нажмите '✅ Выбрать эту папку'\n"
                "4. Нажмите '📸 Загрузить фото'\n"
                "5. Отправьте фотографии (можно несколько сразу)\n"
                "6. Выберите способ именования файлов:\n"
                "   • '📝 Дать название каждому' - ввести название для каждого фото\n"
                "   • '🔄 Все с автоназваниями' - автоматические названия\n\n"
                "<b>📝 Отправка текста:</b>\n"
                "1. После загрузки фото нажмите '📝 Отправить текст'\n"
                "2. Введите ваше ФИО\n"
